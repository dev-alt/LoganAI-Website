...
export function Footer(): ReactElement {
    ...
    return (
        ...
        >
            ...
            <div className="relative mx-auto max-w-7xl overflow-hidden px-6 py-12 sm:py-16">
                <nav
                    className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12"
                    aria-label="Footer"
                >
                    {navigation.main.map((item) => (
                        <div key={item.name} className="pb-6 footer-item">
                            <MotionLink
                                href={item.href}
                ...
                <motion.p
                    className="mt-10 text-center text-xs leading-5 text-muted-foreground footer-item"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
